...
public class BuchungsStornierungFactory {
	public static BuchungsStornierung createStornierung(int BNR) throws RequiredFactoryFailedException, FailedDataInsertionException {
	...
	public static BuchungsStornierung getBuchungsStornierungByStrnNR(int StrnNR) throws ResultSetIsNullException, EmptyResultSetException, FailedObjectCreationException {
		Connection c = Connector.getConnection();
	...
	public static BuchungsStornierung getBuchungsStornierungByBNR(int BNR) throws ResultSetIsNullException, EmptyResultSetException, FailedObjectCreationException {
		Connection c = Connector.getConnection();
	...
	public static BuchungsStornierung[] getBuchungsStornierungByKID(int KID) throws ResultSetIsNullException, EmptyResultSetException, FailedObjectCreationException {
		Connection c = Connector.getConnection();
