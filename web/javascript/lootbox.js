var GewinneGewohnlich = ['Ein einzelnes Popcorn GRATIS', '3ml GRATIS zu deinem Getränk (ausgenommen Bier)', 'Logeneintritt GRATIS (Zum Aufpreis von 2€)', 'GUTSCHEIN: Kaufe 2 Tickets, und nimm zusätzlich zu dir noch eine weitere Person mit', 'KOSTENLOSER Eintritt ins Kino Foyer', '3x Toilettennutzung GRATIS', 'Berechtigung zum Kauf einer weiteren Lootbox', '1 Treuepunkt'];
...
var GewinneEpisch = ['Privatvorstellung im Kino', 'Kino Backstage Tour', 'Treffen mit einem Filmstar', 'Ein kostenloser Kinoeintritt', 'Ein kostenloses Menü', 'Du bekommst für deinen Kinobesuch einen persönlichen Butler, der die während der Vorstellung die Füße massiert', 'Du hast verloren. Du darfst nie wieder unser Kino betreten.'];
